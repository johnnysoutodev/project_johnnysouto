...
export const NAV_LINKS: readonly NavLink[] = [
  { label: $localize`:@@nav.about:Sobre`, href: '#about' },
  { label: $localize`:@@nav.projects:Projetos`, href: '#project' },
  { label: $localize`:@@nav.testimonials:Depoimentos`, href: '#testimonials' },
